...
export default function TermsOfService({
  ...
  return (
    <div className={isTossMode ? "min-h-screen bg-[#F4F8FF] text-slate-700" : "min-h-screen bg-slate-950 text-slate-200"}>
      <header
        className={`sticky z-10 px-4 flex items-center gap-3 ${
          isTossMode
            ? "top-0 py-2 border-b border-[#D9E8FF] bg-[#F4F8FF]"
            : "border-b border-slate-800 bg-slate-950/90 backdrop-blur-sm py-3"
        }`}
        style={isTossMode ? undefined : { top: safeAreaTop }}
      >
        {!isTossMode && (
          <button
            type="button"
      ...
      <main className={`max-w-3xl mx-auto px-4 pb-16 text-sm leading-relaxed space-y-8 ${isTossMode ? "py-6" : "py-8"}`}>
        <section>
          <p className={`text-xs mb-2 ${isTossMode ? "text-slate-500" : "text-slate-400"}`}>시행일: {EFFECTIVE_DATE}</p>
        ...
        <section>
          <h2 className={`text-lg font-bold mb-3 ${isTossMode ? "text-slate-900" : "text-white"}`}>제2조 (정의)</h2>
        ...
        <section>
          <h2 className={`text-lg font-bold mb-3 ${isTossMode ? "text-slate-900" : "text-white"}`}>제3조 (약관의 게시와 개정)</h2>
          <ol className={`list-decimal list-inside space-y-2 ${isTossMode ? "text-slate-700" : "text-slate-300"}`}>
        ...
        <section>
          <h2 className={`text-lg font-bold mb-3 ${isTossMode ? "text-slate-900" : "text-white"}`}>제4조 (서비스의 제공)</h2>
          <ol className={`list-decimal list-inside space-y-2 ${isTossMode ? "text-slate-700" : "text-slate-300"}`}>
        ...
        <section>
          <h2 className={`text-lg font-bold mb-3 ${isTossMode ? "text-slate-900" : "text-white"}`}>제10조 (이용자의 의무)</h2>
          <p className="mb-2">이용자는 다음 행위를 하여서는 안 됩니다.</p>
          <ul className={`list-disc list-inside space-y-1 ${isTossMode ? "text-slate-700" : "text-slate-300"}`}>
        ...
        <section>
          <h2 className={`text-lg font-bold mb-3 ${isTossMode ? "text-slate-900" : "text-white"}`}>제11조 (지식재산권)</h2>
          <p>
        ...
        <section>
          <h2 className={`text-lg font-bold mb-3 ${isTossMode ? "text-slate-900" : "text-white"}`}>제12조 (책임의 한계)</h2>
          <ol className={`list-decimal list-inside space-y-2 ${isTossMode ? "text-slate-700" : "text-slate-300"}`}>
        ...
        <section>
          <h2 className={`text-lg font-bold mb-3 ${isTossMode ? "text-slate-900" : "text-white"}`}>제13조 (분쟁 해결 및 준거법)</h2>
          <ol className={`list-decimal list-inside space-y-2 ${isTossMode ? "text-slate-700" : "text-slate-300"}`}>
        ...
        <section>
          ...
          <p className={`mt-3 text-xs ${isTossMode ? "text-slate-500" : "text-slate-500"}`}>
